...
namespace hd
{
		  ...
		  , m_Params{}
	{
		...
		std::pmr::u8string titleString{ title, &Scratch() };
		std::pmr::wstring wideTitleString{ &Scratch() };
		ToWide(titleString, wideTitleString);
	...
	void SystemWindow::ProcessSystemEvents(CommandBuffer& systemCommands)
	{
